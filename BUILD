...
cc_binary(
    name = "roundrobin",
    srcs = [
        "schedulers/round_robin/roundrobin_agent.cc",
    ],
    copts = compiler_flags,
    deps = [
        ":agent",
...
cc_library(
    name = "roundrobin_scheduler",
    srcs = [
        "schedulers/round_robin/roundrobin_scheduler.cc",
        "schedulers/round_robin/roundrobin_scheduler.h",
    ],
    hdrs = [
        "schedulers/round_robin/roundrobin_scheduler.h",
    ],
